    ...
    <div  id='capsuleA_container'>
      <div id='capsule_Top'>
        <div id='capsule_title'>
          <h3>이디야 캡슐커피</h3>  
          <p>ALWAYS BESIDE YOU,<span id='capsuleA_title_sapn'>CAPSULE COFFEE</span> </p>
        </div>
       <Dplist></Dplist>
      </div>
      <div id='capsule_mid'>
        ...
        <div id='capsuleC_container'>
          <div id='capsuleC_main1'>
            <div id='capsuleC_detail'>
              ...
              <h4 id='capsuleC_detail_a'>PERSONA BLEND</h4>
                <div id='capsuleC_detail_p'>
                  <p>이디야커피만의 오랜 R&D 노하우의 결실로</p>
                  <p>블렌딩 커피가 주는 향미적 복합성에 초점을 맞춘</p>
                  <p>제품으로서 다크 초콜렛, 카라멜, 견과류의</p>
                  <p>고소함 및 부드러운 바디감이 특징</p>
                </div>
            ...
            <div id='capsuleC_detail'>
              ...
              <h4 id='capsuleC_detail_b'>COLOMBIA SUPREMO</h4>
              <div id='capsuleC_detail_p'>
                <p>부드러운 바닐라와 아몬드가 가진</p>
                <p>고소함과 은은한 향미의 안정적인</p>
                <p>밸런스가 특징인 제품</p>
              </div>
            ...
            <div id='capsuleC_detail'>
              ...
              <h4 id='capsuleC_detail_c'>ETHIOPIA LIMMU</h4>
              <div id='capsuleC_detail_p'>
                <p>에티오피아 최고의 고지대에서 자라</p>
                <p>은은하고 선명한 플로럴한 향미와</p>
                <p>케인 슈가의 달콤한 후미가 특징인 제품</p>
              </div>
