...
import '../service_guide/service_guide.css'

function Service_guide() {
  return(
    <div id="service_item_body">
      <div id="service_item_back">
        <div id="service_textbox1">
          <div id="ser_textbox1_1"><p>서비스 안내</p></div>
          <div id="ser_textbox1_2"><p>이디야멤버스 다양한 서비스를 소개합니다.</p></div>
        </div> 
      </div>

      <div id="service_item_back1">
        <div id="service_textbox1">
          <div id="ser_textbox2_1"><p>이디야멤버스 회원이라면 누릴 수 있는 <br/>모든 것을 안내드립니다.</p></div>
        </div>
      </div>
